...
{	
	...
	{ 
		...
		HashJoinTuple hashTuple = hjstate->hj_Outer_CurTuple;
		uint32		hashvalue = hjstate->hj_Inner_CurHashValue;
		/*
		...
		*/
		if (hashTuple == NULL)
			hashTuple = hashtable->buckets[hjstate->hj_Outer_CurBucketNo];
		else
